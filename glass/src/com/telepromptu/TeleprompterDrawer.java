...
public class TeleprompterDrawer implements SurfaceHolder.Callback {
    ...
    public TeleprompterDrawer(Context context) {
        ...
        mCountDownView.setListener(new CountDownView.CountDownListener() {
            ...
            public void onFinish() {
                mCountDownDone = true;
                mTeleprompterView.setBaseMillis(SystemClock.elapsedRealtime());
                if (mHolder != null) {
                    mTeleprompterView.start();
                }
        ...
        mTeleprompterView = new TeleprompterView(context);
        mTeleprompterView.setListener(new TeleprompterView.ChangeListener() {

            @Override
            public void onChange() {
                draw(mTeleprompterView);
            }
        });
        mTeleprompterView.setForceStart(true);
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        ...
        mTeleprompterView.measure(measuredWidth, measuredHeight);
        mTeleprompterView.layout(
                0, 0, mTeleprompterView.getMeasuredWidth(), mTeleprompterView.getMeasuredHeight());
    }
